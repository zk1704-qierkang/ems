			...
			return {
				arr:[{text:'首页',index:'101',url:'/'},
					 ...
					 {text:'统计信息',index:'108',children:[
					 	 {text:'成本核算信息',index:'1081',url:'DevinfoList'},
					 	 {text:'设备运行时长',index:'1082',url:'Devinfo'},
					 	 {text:'流程能耗对比',index:'1083',url:'Devinfo2'}
					 ]},
					 ...
					 {text:'能源产销模型',index:'1010',children:[
					 	 ...
					 	 {text:'产销模型展示',index:'10102',url:'/EnergyModel'}
					 ]}
				]
			};
		},
